...
let pathFichiersRat = "../../../../../tests/projet/conditionnelle/fichiersRat/"

(***********)
(*  TESTS  *)
(***********)

let%expect_test "testConditionnelle1" =
  runtam (pathFichiersRat^"testConditionnelle1.rat");
  [%expect{| 0246810 |}]

let%expect_test "testConditionnelle2" =
  runtam (pathFichiersRat^"testConditionnelle2.rat");
  [%expect{| 002040608010 |}]

(*
let%test_unit "testConditionnelle2" =
  try 
    let _ = runtam (pathFichiersRat^"testConditionnelle2.rat")
